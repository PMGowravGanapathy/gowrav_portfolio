export default function Footer() {
  return (
    <footer
  className="text-white px-24 py-20 border-t border-white/5
...
>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        {/* Navigation */}
        <div>
          <p className="text-gold tracking-widest text-sm mb-4">NAVIGATION</p>
          ...
          <ul className="space-y-3 text-gray text-sm">
            ...
            <li><a href="#work" className="hover:text-gold transition">Projects</a></li>
        ...
        {/* Contact */}
        <div>
          <p className="text-gold tracking-widest text-sm mb-4">CONNECT</p>
          ...
          <ul className="space-y-3 text-gray text-sm">
            ...
            <li className="flex gap-6 pt-2">
              ...
              >
               ...
               <a
                href="https://www.instagram.com/parlakoti_gowrav?igsh=djVsanRiYXZsNzRm"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-gold transition"
              >
      ...
      {/* Bottom Bar */}
      <div className="mt-16 pt-6 border-t border-white/5 text-center text-gray text-sm">
        <p>
          © {new Date().getFullYear()} PM Gowrav Ganapathy. All rights reserved.
        </p>

        <p className="mt-2">
          Designed with love <span className="text-red-500">❤️</span> by PM Gowrav Ganapathy.
        </p>
      </div>
